...
from newton_auth.async_http import AsyncNewtonAuthHTTPClient
...
class AsyncNewtonAuth:
    def __init__(self, **kwargs):
        ...
        self.http = AsyncNewtonAuthHTTPClient(
    ...
    async def authenticate(self, request, response=None) -> AuthResult:
        ...
        data = await self.http.auth_check(uid=uid, platform_token=session["platform_token"])
